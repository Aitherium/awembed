"""Stack-aware `doctor` for awembed.
...
interesting failures live BETWEEN them. "awembed is installed" is not the useful
fact -- "awembed is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awembed needs at runtime, and a
